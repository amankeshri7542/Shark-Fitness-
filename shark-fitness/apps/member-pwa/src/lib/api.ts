...
const CSRF_KEY = 'shark.member.csrf';
...
export const csrf = {
  ...
  set: (value: string): void => {
    try {
      ...
      /* in-memory cookie session still works until reload */
    }
  },
  clear: (): void => {
    try {
...
/** Compatibility shim while callers migrate from bearer tokens. Authentication now lives only in the HttpOnly cookie. */
export const auth = {
