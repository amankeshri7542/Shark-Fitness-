...
export const PlatformHealth = z.object({
  ...
  jobs: z.array(z.object({
    ...
    lastSuccessfulRunAt: IsoDateTime.nullable(),
    lastFailedRunAt: IsoDateTime.nullable(),
    lastFailureCategory: z.string().nullable(),
    lastFailureMessage: z.string().nullable(),
    nextExpectedAt: IsoDateTime.nullable(),
    health: z.enum(['healthy', 'stale', 'failing', 'never', 'disabled']),
  })),
